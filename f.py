...
# -------------------- TC-02 : Ajouter "Sauce Labs Backpack" et vérifier le panier --------------------
driver.find_element(By.ID, "add-to-cart-sauce-labs-backpack").click()
time.sleep(1)
driver.find_element(By.ID, "shopping_cart_container").click()
time.sleep(2)
try:
    produit = driver.find_element(By.XPATH, "//div[@class='inventory_item_name' and text()='Sauce Labs Backpack']")
...
produits = ["Sauce Labs Bolt T-Shirt"]  # On supprime Onesie qui n'existe pas
driver.find_element(By.ID, "shopping_cart_container").click()
time.sleep(2)
for nom in produits:
    try:
...
try:
    ...
    # Deuxième ajout (vérifier impossibilité)
    try:
        driver.find_element(By.ID, produit_id_add).click()
